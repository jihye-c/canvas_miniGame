export default class GameHandler{
    ...
    init(){
        ...
        this.finsishScreen = document.querySelector('.finish-screen');
        this.distanceText = this.finsishScreen.querySelector('.distance')
        this.coinText = this.finsishScreen.querySelector('.coin')
        this.replayBtn = this.finsishScreen.querySelector('.replay-img');
    ...
    showReadyScreen(){
        ...
        gsap.to(this.playBtn,{
            scale:1, duration:1, ease:Elastic.easeOut.config(2,0.5),dealy:0.5
        })
    }
    hideReadyScreen(){
        gsap.to(this.readyScreen,{
            opacity:0, pointerEvents:'none', duration:0.3, onComplet:()=>{
                this.status = 'PLAYING'
            }
        })
    }
    showFinishScreen(){
        ...
        gsap.fromTo(this.finsishScreen,{opacity:0},{
    ...
    hideFinishScreen(){
        gsap.fromTo(this.finsishScreen,{opacity:1},{
